...
TEST(serialization, serialize_real) {
    ...
    auto solution_matrix = LaxFriedrichsSolver<Real>(initial_conditions, discretization_size, num_timesteps, delta_t, delta_x, new CubicFlux<Real>()).solve();
...
TEST(serialization, serialize_interval) {
    ...
    auto solution_matrix = LaxFriedrichsSolver<Winterval>(initial_conditions, discretization_size, num_timesteps, delta_t, delta_x, new CubicFlux<Winterval>()).solve();
...
TEST(serialization, serialize_affine) {
    ...
    auto solution_matrix = LaxFriedrichsSolver<AffineForm>(initial_conditions, discretization_size, num_timesteps, delta_t, delta_x, new CubicFlux<AffineForm>()).solve();
...
TEST(serialization, serialize_mixed) {
    ...
    auto solution_matrix = LaxFriedrichsSolver<MixedForm>(initial_conditions, discretization_size, num_timesteps, delta_t, delta_x, new CubicFlux<MixedForm>()).solve();
